...
?>
	...
	<div class="col-sm-4 text-justify">
     ...
     <center><img src="devlop/iron.png"class="img-responsive"style="width:200px;height:150px;border-radius:100%;"></center>
	</div>&nbsp;
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>Developed with love By HARDHEEK,AJAY and MOHNISH @ | All Rights Reserved 2021</p>
</footer>
